...
const EDITOR_SHORTCUTS: ShortcutRow[] = [
    ...
    { keys: 'Enter', name: 'New line or Send', detail: 'Default: insert a normal newline; send mode: send current line or selection' },
    { keys: 'F8', name: 'Send', detail: 'Send current line or selection (blocked inside code blocks)' },
