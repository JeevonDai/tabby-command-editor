...
export const ZH_CN_TRANSLATIONS: Record<string, string> = {
    ...
    'Add a new line below the current line without sending': '在当前行下方新增一行，不发送命令',
    'Add a new line above the current line without sending': '在当前行上方新增一行，不发送命令',
    ...
    'Multi-line send interval': '多行发送间隔',
    'Delay between commands when sending a multi-line selection.': '发送多行选区时，每条命令之间的等待时间。',
